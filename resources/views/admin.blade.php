                                ...
                                <div class="main-card mb-3 card">
                                    <div class="card-header">Active Users
                                        <div class="btn-actions-pane-right">
                                            <div role="group" class="btn-group-sm btn-group">
                                                <a class="btn" href="{{url('/create')}}">Add New Blog</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="container">
                                    <div class="table-responsive">
                                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                            ...
                                            <td class="text-center"><img src="/image/{{$blog->Image}}" width="50px" alt=""></td>
                                            <td class="text-center">{{$blog->Tags}}</td>
                                            <td class="text-center">{{$blog->SEO_description}}</td>
                                            <td class="text-center">{{$blog->SEO_Title}}</td>
                                            <td class="text-center">{{$blog->Meta_keywords}}</td>
                                            <td class="text-center">{{$blog->Category_id}}</td>
                                            <td class="text-center">{{$blog->approve}}</td>
                                            <td>
                                                <form action="" method="POST">
                            
                                                    <a href="{{url('/approve',$blog->id)}}" >
                                                        <i class=" btn  btn-success  fa-lg"> Approve</i> </a>
                                                    <a href="{{url('/edit',$blog->id)}}" title="show">
